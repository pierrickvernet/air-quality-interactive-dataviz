...
- **Variables temporelles :** Horodatage avec fréquence journalière et horaire.
...
- **Traitement des données manquantes :** Évaluation quantitative des taux de complétion par variable et suppression ciblée des variables présentant un déficit d'observations critique.
- **Ingénierie temporelle & Feature Engineering :** Harmonisation des types de données, extraction systématique des composantes temporelles (cycles horaires, variations saisonnières, composantes mensuelles).
...
- **Quantification aérologique :** Calcul du rapport de corrélation ($\eta^2 = 0,0976$) pour estimer la part de variance du polluant expliquée par la provenance sectorielle des masses d'air.
...
- **Saisonnalité & Température :** Alignement synchrone entre la concentration maximale d'Ozone, les épisodes de fortes chaleurs estivales et le pic solaire d'après-midi.
...
- **Impact du Vent :** Quantification de la dépendance à la direction du vent ($\eta^2 \approx 9,76\ \%$), démontrant un effet mesurable des directions de vent sur la stagnation ou le balayage des polluants.
...
- Intégrer des modèles de séries temporelles (ARIMA) pour la prévision à court terme des dépassements de seuils d'alerte.
